...
pretrain_model_file = "/workdir/tensorrtx/tsm/ckpt.best.pth.tar"
parser.add_argument('--tune_from', type=str, default=pretrain_model_file, help='fine-tune from checkpoint')
...
# ckpt_path = "/workdir/temporal-shift-module/checkpoint/TSM_kinetics_RGB_resnet50_shift8_blockres_avg_segment8_e50"
# parser.add_argument('--resume', default=ckpt_path, type=str, metavar='PATH',
#                     help='path to latest checkpoint (default: none)')
...
parser.add_argument('--root_log',type=str, default='{}/output/log'.format(cur_dir))
parser.add_argument('--root_model', type=str, default='{}/output/checkpoint'.format(cur_dir))
