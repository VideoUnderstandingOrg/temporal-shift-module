...
def return_custom_dataset(modality):
    filename_categories = 9
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'custom_dataset/images'
        filename_imglist_train = 'custom_dataset/labels/train_videofolder.txt'
        filename_imglist_val = 'custom_dataset/labels/val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, "custom_dataset": return_custom_dataset}
